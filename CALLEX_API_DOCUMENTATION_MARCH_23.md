...
> **Version:** 2.1 | **Updated:** March 23, 2026
...
* **Method:** `GET`
* **URL:** `/v1/calls`
* **Query Parameters:** `page` (default 1), `limit` (default 50), `status` (active/completed)
...
*Note: You can pass actual `File` blobs purely via `multipart/form-data`. If you just want to pass dispositions and no file, standard JSON is completely fine.*
